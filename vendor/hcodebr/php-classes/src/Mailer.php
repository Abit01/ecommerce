...
class Mailer{
	...
	const USERNAME = "miqscosta@gmail.com";
	const PASSWORD = "a1m2s3c44002";
	const NAME_FROM = "Andre Costa";
	...
	public function __construct($toAddress, $toName, $subject, $tplName, $data = array())
	{
		...
		foreach ($data as $key => $value) {
			$tpl->assign($key, $value);//SE DER ERRO TIRA ESSE PONTO E VIRGULAAAAAAAAAAAAAAAAAAAAAA		
		}
